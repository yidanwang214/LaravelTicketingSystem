<section>
    ...
    {{-- input will go to the post request of a Route called Profile.update --}}
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        @csrf
        @method('patch') {{-- this is method spoofing, seems like a post request but actually a patch method  --}}
